...
#define CMD_SUSFS_HIDE_SUS_MNTS_FOR_NON_SU_PROCS 0x55563
#define CMD_SUSFS_ADD_SUS_MAP 0x555c5
#define CMD_SUSFS_ENABLE_AVC_LOG_SPOOFING 0x555d5
...
#define DEFAULT_KSU_MNT_ID DEFAULT_SUS_MNT_ID
...
#define DEFAULT_KSU_MNT_GROUP_ID DEFAULT_SUS_MNT_GROUP_ID
...
#define TIF_SUSFS_UMOUNTED 34
static inline bool susfs_is_current_proc_umounted(void) {
	return test_ti_thread_flag(&current->thread_info, TIF_SUSFS_UMOUNTED);
}

static inline void susfs_set_current_proc_umounted(void) {
	set_ti_thread_flag(&current->thread_info, TIF_SUSFS_UMOUNTED);
}
